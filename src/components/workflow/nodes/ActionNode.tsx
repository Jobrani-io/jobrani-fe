...
import { Send, X, UserPlus, Eye, MessageSquare, Heart, Clock, GitBranch } from 'lucide-react';
...
const ActionNode: React.FC<ActionNodeProps> = ({ id, data }) => {
  ...
  const IconComponent = (data.icon && iconMap[data.icon as keyof typeof iconMap]) || Send;
